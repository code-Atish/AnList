...
import { modifySortText, modifySortValue, modifySortVisibility } from './store/sort-slice';
...
function AppliedArrayFilters({inputArray,setInput}){
  ...
  return (
    Boolean(inputArray.length)) && inputArray.map((ele,index) =>(
